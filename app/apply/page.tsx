  ...
  if (submitted) return (
    <main style={{ minHeight: "100vh", background: "var(--obsidian)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      <div style={{ maxWidth: 560, textAlign: "center" }}>
        ...
        <p style={{ fontSize:11, color:"var(--text-muted)", marginTop:24, lineHeight:1.6, maxWidth:480, margin:"24px auto 0" }}>This application is for informational purposes only. Submitting this form does not guarantee employment or a position on Derek Huit's team. Hive Mortgage Academy and Huitai LLC are educational platforms; mortgage origination employment is governed by the sponsoring NMLS-licensed entity at time of hire. Individual hiring decisions are separate from Academy enrollment.</p>
      </div>
    </main>
  );
